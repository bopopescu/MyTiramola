...
cons_trans     = True
CONF_FILE      = TIRAMOLA_DIR + "complex_5k/mid.json"
##############################################################
...
print("Average total rewards : %s" % mean(total_reward_results))
print("Average total splits  : %s" % mean(total_splits_results))
print("Average good splits   : %s" % mean(good_splits_results))
print("Average good splits % : %s" % (100 * mean(good_splits_results) / mean(total_splits_results)))
print("")
